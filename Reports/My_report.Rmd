...
$$ \overline{X}  = \frac{\sum_i^nx}{n}\tag{i}$$
where, $\overline{X}$ represents mean, $x$ is observation and $n$ is number of observation.


$$\int x^ndx = \frac{1}{n + 1} x^{n + 1}\tag{ii}$$

$$ \int sinh\space ax\space dx = \frac{1}{a}\space cosh\space ax \tag{iii} $$
